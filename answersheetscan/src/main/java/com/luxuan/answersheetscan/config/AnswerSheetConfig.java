...
public class AnswerSheetConfig {
    ...
    public static final float OFFSET_BOTTOM_FACTOR_BY_HEIGHT=OFFSET_BOTTOM/TARGET_AREA_HEIGHT;

    public static final float EMPTY_COL_WIDTH_FACTOR_BY_WIDTH=EMPTY_COL_WIDTH/TARGET_AREA_WIDTH;

    public static final float EMPTY_ROW_HEIGHT_FACTOR_BY_HEIGHT=EMPTY_ROW_HEIGHT/TARGET_AREA_HEIGHT;
